...
document.addEventListener('DOMContentLoaded', function() {
  ...
  if (contactForm) {
    ...
    function validateField(input) {
      ...
      if (input === emailInput && emailInput) {
        if (!value) {
      ...
      } else if (input === nameInput && nameInput) {
        if (!value) {
      ...
      } else if (input === messageInput && messageInput) {
        if (!value) {
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '017c1dda-cf16-470c-a99b-178b43539254',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '017c1dda-cf16-470c-a99b-178b43539254';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '017c1dda-cf16-470c-a99b-178b43539254';
